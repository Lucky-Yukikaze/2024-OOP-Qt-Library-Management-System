...
struct qt_meta_stringdata_CLASSCell_BookMgrENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCell_BookMgrENDCLASS = QtMocHelpers::stringData(
    "Cell_BookMgr",
    "on_btn_add_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCell_BookMgrENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Cell_BookMgr::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSCell_BookMgrENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCell_BookMgrENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCell_BookMgrENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Cell_BookMgr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_btn_borrow_clicked(); break;
        case 2: _t->on_btn_del_clicked(); break;
        case 3: _t->on_btn_update_clicked(); break;
...
void *Cell_BookMgr::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCell_BookMgrENDCLASS.stringdata0))
