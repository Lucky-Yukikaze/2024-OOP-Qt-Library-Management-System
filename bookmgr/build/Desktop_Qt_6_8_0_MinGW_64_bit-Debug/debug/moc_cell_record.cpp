...
struct qt_meta_stringdata_CLASSCell_RecordENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCell_RecordENDCLASS = QtMocHelpers::stringData(
    "Cell_Record",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCell_RecordENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Cell_Record::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSCell_RecordENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCell_RecordENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCell_RecordENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Cell_Record::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCell_RecordENDCLASS.stringdata0))
